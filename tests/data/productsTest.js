...
describe(`Test suite: Product`, () => {
  ...
  beforeEach(() => {
    product = new Product({
      id: "e43638ce-6aa0-4b85-b27f-e1d078c6eb67",
  ...
  it("has the correct properties", () => {
    expect(product.id).toEqual("e43638ce-6aa0-4b85-b27f-e1d078c6eb67");
...
describe("Test sutie: Clothing", () => {
  ...
  it("displays a size chart link in extraInfoHTML", () => {
    // It's hard to match a multiline string exactly, so
    // we'll just check if the result contains certain strings.
